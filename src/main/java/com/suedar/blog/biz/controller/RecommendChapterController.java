...
public class RecommendChapterController {
    ...
    public BaseResult<Integer> insert(@RequestBody RecommendChapter recommendChapter) {
    ...
    public BaseResult<Page<List<RecommendChapter>>> pageQuery(@RequestBody RecommendChapterPageQuery query) {
